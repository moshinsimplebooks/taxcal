...
export default function InvestIncList() {
    ...
    const handleDeletes = (id) => {
        ...
        const newTaxes = filterInvestTaxes.filter((tax) => tax.id !== id);
        ...
        <div className="col-sm-7 mb-3 mb-sm-0">
            <div className="card border-0">
                <div className="card-body py-0">
                    <h5 className="card-title">Invest Income</h5>
                    ...
                    <div>
                        <table className="table table-striped" >
                            ...
                            <tbody>
                                {
                                    filterInvestTaxes.length > 0 ? (
                                        filterInvestTaxes.map((tax) => (
                                            <tr key={tax.id}>
                                                <td>{tax.type}</td>
