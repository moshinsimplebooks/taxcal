...
import OtherIncYup from '../../../../Utils/validation/OtherIncYup/OtherIncYup';

export default function OtherIncForm() {
    const dispatch = useDispatch()
    const taxes = useSelector((state) => state.taxes)

    const filterOtherIncTaxes = taxes.filter(tax => tax.source === "empOtherInc")
    ...
    const { values, handleChange, handleSubmit, errors, touched } = useFormik({
        ...
        validationSchema: OtherIncYup.createBuisnessIncome,
        onSubmit: (values) => {
            try {
            ...
            <form className='needs-validation' noValidate onSubmit={handleSubmit}>
                ...
                <div className="row mb-1">
                    <div className="col-12">
                        <button type='submit' className='btn btn-success w-100'>Add Other Income</button>
                    </div>
                </div>
            </form>
