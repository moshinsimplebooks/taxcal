...
import DonationYup from '../../../../Utils/validation/DonationYup/DonationYup'
...
export default function DonationForm() {
    ...
    const { values, handleChange, handleSubmit, errors, touched } = useFormik({
        ...
        validationSchema: DonationYup.createDonationDeduction,
        onSubmit: (values) => {
            try {
            ...
            <form className='needs-validation' noValidate onSubmit={handleSubmit}>
                ...
                <div className="row mb-1">
                    <div className="col-12">
                        <button  type='submit' className='btn btn-success w-100'>Add Donations</button>
                    </div>
                </div>
            </form>
